...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://raw.githubusercontent.com/ONKK/aaBT/main/resource/LinuxPanel_EN-6.8.23.zip"
red "下载完成,正在降级."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://raw.githubusercontent.com/ONKK/aaBT/main/script/downgrade.sh" 
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://raw.githubusercontent.com/ONKK/aaBT/main/resource/LinuxPanel-7.7.0.zip"
blue "下载完成,正在降级."
...
wget https://raw.githubusercontent.com/ONKK/aaBT/main/script/repair.json
chattr +i /www/server/panel/data/repair.json
red "开心成功."
}
...
red "清理成功."
red "如果想删除此脚本 请执行 rm aabt.sh -rf "
}
...
wget -O /root/chinese.zip https://raw.githubusercontent.com/ONKK/aaBT/main/resource/aapanel_chinese_6.8.21.zip
...
function start_menu(){
    clear
    purple " 感谢使用aaBT小助手."
    purple " https://github.com/ONKK/aaBT"
    yellow " ————————————————————————————————————————————————"
    green " 1. CentOS/Debian/Ubuntu 安装 aaPanel"
    green " 2. CentOS/Debian/Ubuntu 安装 宝塔面板"
    yellow " ————————————————————————————————————————————————"
    green " 3. 降级 6.8.23 版本 aaPanel & 允许admin 验证码 关闭安全入口"
    green " 4. 降级 7.7.0  版本 宝塔面板 & 屏蔽绑定 允许admin 验证码 关闭安全入口"
    green " 5. 开心破解"
